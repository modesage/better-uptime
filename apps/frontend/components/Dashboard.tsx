...
export default function DashboardPage({ onSignOut }: DashboardProps) {
  ...
  const handleAddWebsite = async (url: string) => {
    ...
    try {
      await axios.post(`${BACKEND_URL}/website`, { url }, {
        headers: {
          Authorization: token
        }
      })
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      fetchWebsites(); //every minute fetch websites
    }, 60 * 1000); 
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      <Button onClick={() => handleAddWebsite(newUrl)} className="cursor-pointer">
                        Add Website
                      </Button>
                    </div>
                  </div>
                  ...
                  <TableRow key={website.id}>
                    ...
                    <TableCell>
                      <Button variant="ghost" size="sm" asChild>
                        <a href={`/website/${website.id}`} target="_blank" rel="noopener noreferrer">
